...
class MetricsLogger:
    """Comprehensive metrics logging with W&B."""

    def __init__(self, log_dir: str, model_name: str, config: TrainingConfig):
...
def train_model(config: TrainingConfig):
    ...
    # Metrics logger
    logger = MetricsLogger(str(output_dir), config.model_type, config)
    ...
    for epoch in epoch_pbar:
        ...
        epoch_pbar.set_postfix({
            ...
            "val_ppl": f"{epoch_metrics['val_perplexity']:.2f}",
        })
