...
# conda env remove -n deepseek-ocr -y 2>/dev/null || true
...
conda env remove -n olmocr -y 2>/dev/null || true
...
# ls -la
conda run -n olmocr python -m olmocr.pipeline ../../../outputs/olmocr_workspace --markdown --pdfs ../../../data/OmniDocBench/pdfs/book_en_5.Advanced.Modern.Algebra.-.J.Rotman.2003_page_572.pdf
