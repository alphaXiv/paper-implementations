<|ref|>table<|/ref|><|det|>[[102, 81, 822, 199]]<|/det|>
...
<|ref|>sub_title<|/ref|><|det|>[[92, 223, 301, 244]]<|/det|>
## Creating Dialog Boxes  

<|ref|>text<|/ref|><|det|>[[115, 258, 456, 273]]<|/det|>
Dialog boxes may be created in one of two ways:  

<|ref|>text<|/ref|><|det|>[[115, 285, 840, 370]]<|/det|>
- Using the function GetNewDialog, which takes descriptive information about the dialog from dialog ('DLOG') and extended dialog ('d1gx') resources. The resource ID of the 'DLOG' and 'd1gx' resources must be the same, and is passed in the first parameter of this function.- Using NewDialog, NewColorDialog, or NewFeaturesDialog, which take descriptive information passed in the parameters of those functions.  

<|ref|>sub_title<|/ref|><|det|>[[166, 391, 268, 405]]<|/det|>
## Historical Note  

<|ref|>text<|/ref|><|det|>[[166, 416, 783, 466]]<|/det|>
...
<|ref|>text<|/ref|><|det|>[[115, 488, 840, 589]]<|/det|>
...
<|ref|>text<|/ref|><|det|>[[115, 600, 839, 630]]<|/det|>
...
<|ref|>sub_title<|/ref|><|det|>[[93, 641, 264, 659]]<|/det|>
## The Dialog Structure  

<|ref|>text<|/ref|><|det|>[[115, 672, 780, 687]]<|/det|>
The dialog structure created by the GetNewDialog call is defined by the data type DialogRecord:  

<|ref|>text<|/ref|><|det|>[[137, 700, 648, 824]]<|/det|>
struct DialogRecord {  WindowRecord window; // Dialog's window record.  Handle items; // Item list resource.  TEHandle textl; // Current editable text item.  SInt16 editField; // Editable text item number minus 1.  SInt16 editOpen; // (Used internally.)  SInt16 aDeftem; // Default push button item number.  };  typedef struct DialogRecord DialogRecord;  typedef DialogRecord \*DialogPeek;  

<|ref|>text<|/ref|><|det|>[[115, 834, 839, 863]]<|/det|>
